...
const HeadControls = (function () {
  ...
  function init_headSearchDraw() {
    ...
    _headSearchUniformXys = _gl.getUniformLocation(
      _glHeadSearchDrawShaderProgram,
      "uxys"
    );
  ...
  function draw_headSearch(detectState) {
    ...
    _gl.uniform3f(
      _headSearchUniformXys,
      detectState.x,
      detectState.y,
      detectState.s
    );
    _gl.uniformMatrix2fv(
      _headSearchUniformVideoTransformMat2,
      false,
      _videoTransformMat2
    );
  ...
  const that = {
    init: function (spec) {
      ...
      _disableRestPosition =
        typeof spec.disableRestPosition === "undefined"
          ? false
          : spec.disableRestPosition;
      ...
      JEELIZFACEFILTER.init({
        ...
        callbackReady: function (errCode, jeeFaceFilterObj) {
          console.log("JEELIZ READY:", errCode);
          if (errCode) {
